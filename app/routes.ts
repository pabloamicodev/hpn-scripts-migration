...
export default [
  ...
  route("app", "routes/app.tsx", [
    ...
    route("subscription-pricing", "routes/app.subscription-pricing.tsx"),
    route("subscription-pricing/new", "routes/app.subscription-pricing.new.tsx"),
    route("subscription-pricing/:id", "routes/app.subscription-pricing.$id.tsx"),
